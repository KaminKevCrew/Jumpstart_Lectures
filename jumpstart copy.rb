...
# [5, 6, 8, 4, 6].each.with_index do |variable, index|
...
str1 = "aaabcdeef" #=> ["aa", "aa", "ee"]

#print each set of repeating elements
...
def output_repeating_char(str)
  ...
  # previous_char = str[0] # no index
  # str[1..-1].each_char do |char|
  #   if char == previous_char
  #     pairs << char + previous_char
  #   end
  #   previous_char = char
  # end
  # return pairs
...
#   times_two_array = []
#   arr.each { |number| times_two_array << number * 2 }
#   # return times_two_array
# end
...
# p better_capitalize("wHy dOES Aj ALWays wANT TO tell me WHAT to dOOOOO")
# p "wHy dOES Aj ALWays wANT TO. tell me WHAT to dOOOOO".capitalize
...
#   words.each do |longer_word|
#     # longest_word = words[idx + 1]
#     if longest_word.length < longer_word.length
#       longest_word = longer_word
#     end
#   end
#   return longest_word
# end
...
def magic_number?(n)
  # return a boolean
  digit_string = n.to_s
  ind_digits = digit_string.split('')
  # p ind_digits
  magic_num = 0
  ind_digits.each do |number|
    magic_num += number.to_i
  end
  return magic_num == 7
end

# p magic_number?(124) #=> true
# p magic_number?(44444) #=> false
